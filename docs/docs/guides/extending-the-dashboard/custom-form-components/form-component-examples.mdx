...
```tsx title="src/plugins/my-plugin/dashboard/components/slug-input.tsx"
    import { Input, Button, Switch, DashboardFormComponent, useFormContext } from '@vendure/dashboard';
...
- **[Form Input Components Overview](./)** - Learn how to choose between custom field components and native detail-page input overrides
