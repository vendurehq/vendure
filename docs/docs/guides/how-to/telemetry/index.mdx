...
This version renames the attributes on HTTP and database spans. Names like `http.method` and
...
This happens whether or not you customise `instrumentations`.
...
This version redacts sensitive query parameters on spans for incoming requests. Earlier versions
only did this for outgoing requests.
...
pass your own `instrumentations` array to do this, as shown above.
:::
