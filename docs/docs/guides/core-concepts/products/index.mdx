...
A product does not have to use option groups. It may hold any number of variants with no options at all, told
apart by their name, SKU or other properties.
