---
title: 'The API Layer'
metaTitle: "Vendure API Layer - GraphQL Resolvers, Guards, and Middleware"
metaDescription: "Trace the lifecycle of a GraphQL API request in Vendure, from middleware and authentication guards through resolvers to the service layer and back."
order: 1
---
