---
title: 'Plugins'
metaTitle: "Vendure Plugin System - Building and Configuring Plugins"
metaDescription: "Everything you need to know about Vendure plugins: creating custom plugins, lifecycle hooks, defining providers, and extending the server with modular features."
order: 6
---
...
If you use AI coding agents or want automated checks for common plugin mistakes, see the
