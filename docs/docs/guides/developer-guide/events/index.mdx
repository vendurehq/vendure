---
title: 'Events'
metaTitle: "Vendure EventBus - Subscribe to System Events in Plugins"
metaDescription: "A complete reference of Vendure events and how to subscribe to entity changes, order state transitions, and user actions using the EventBus."
---
...
-   [`RoleAssignmentEvent`](/reference/typescript-api/events/event-types#roleassignmentevent)
