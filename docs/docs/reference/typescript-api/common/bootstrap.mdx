...
<GenerationInfo sourceFile="packages/core/src/bootstrap.ts" sourceLine="211" packageName="@vendure/core" />
...
<GenerationInfo sourceFile="packages/core/src/bootstrap.ts" sourceLine="66" packageName="@vendure/core" since="2.2.0" />
