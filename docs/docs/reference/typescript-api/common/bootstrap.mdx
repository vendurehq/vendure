...
<GenerationInfo sourceFile="packages/core/src/bootstrap.ts" sourceLine="192" packageName="@vendure/core" />
...
<GenerationInfo sourceFile="packages/core/src/bootstrap.ts" sourceLine="47" packageName="@vendure/core" since="2.2.0" />
