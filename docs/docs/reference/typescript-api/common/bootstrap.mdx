...
<GenerationInfo sourceFile="packages/core/src/bootstrap.ts" sourceLine="207" packageName="@vendure/core" />
...
<GenerationInfo sourceFile="packages/core/src/bootstrap.ts" sourceLine="62" packageName="@vendure/core" since="2.2.0" />
