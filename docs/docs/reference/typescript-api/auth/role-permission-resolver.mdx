...
generated: true
---
<GenerationInfo sourceFile="packages/core/src/service/helpers/role-permission-resolver/role-permission-resolver.ts" sourceLine="73" packageName="@vendure/core" since="4.0.0" />
...
- **SuperAdmin**: a User holding a Role which carries the `SuperAdmin` permission (only
  ...
  (see [RoleAssignment](/reference/typescript-api/entities/role-assignment#roleassignment)); Channel creation writes no assignment rows.
