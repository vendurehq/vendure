...
generated: true
---
<GenerationInfo sourceFile="packages/core/src/service/helpers/external-authentication/external-authentication.service.ts" sourceLine="27" packageName="@vendure/core" />
...
class ExternalAuthenticationService {
    ...
    setAdministratorAvatar(ctx: RequestContext, userId: ID, avatar: Promise<StoredMediaUpload> | StoredMediaUpload | null) => Promise<Administrator>;
...
only be linked to that existing account when `config.verified` is `true`. An [AuthenticationStrategy](/reference/typescript-api/auth/authentication-strategy#authenticationstrategy)
...
will throw an [UnverifiedExternalEmailError](/reference/typescript-api/errors/error-types#unverifiedexternalemailerror).
### createAdministratorAndUser

<MemberInfo kind="method" type={`(ctx: <a href='/reference/typescript-api/request/request-context#requestcontext'>RequestContext</a>, config: {             strategy: string;             externalIdentifier: string;             identifier: string;             emailAddress?: string;             firstName?: string;             lastName?: string;             roles: <a href='/reference/typescript-api/entities/role#role'>Role</a>[];             /** An optional provider profile image to use as the <a href='/reference/typescript-api/entities/administrator#administrator'>Administrator</a> avatar. */             avatar?: Promise<<a href='/reference/typescript-api/assets/stored-media-upload#storedmediaupload'>StoredMediaUpload</a>> | <a href='/reference/typescript-api/assets/stored-media-upload#storedmediaupload'>StoredMediaUpload</a>;         }) => `}   />
...
### setAdministratorAvatar

<MemberInfo kind="method" type={`(ctx: <a href='/reference/typescript-api/request/request-context#requestcontext'>RequestContext</a>, userId: <a href='/reference/typescript-api/common/id#id'>ID</a>, avatar: Promise<<a href='/reference/typescript-api/assets/stored-media-upload#storedmediaupload'>StoredMediaUpload</a>> | <a href='/reference/typescript-api/assets/stored-media-upload#storedmediaupload'>StoredMediaUpload</a> | null) => Promise<<a href='/reference/typescript-api/entities/administrator#administrator'>Administrator</a>>`}   />
