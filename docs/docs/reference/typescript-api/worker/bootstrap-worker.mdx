...
<GenerationInfo sourceFile="packages/core/src/bootstrap.ts" sourceLine="282" packageName="@vendure/core" />
...
<GenerationInfo sourceFile="packages/core/src/bootstrap.ts" sourceLine="136" packageName="@vendure/core" since="2.2.0" />
