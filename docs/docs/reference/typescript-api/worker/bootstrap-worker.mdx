...
<GenerationInfo sourceFile="packages/core/src/bootstrap.ts" sourceLine="258" packageName="@vendure/core" />
...
<GenerationInfo sourceFile="packages/core/src/bootstrap.ts" sourceLine="117" packageName="@vendure/core" since="2.2.0" />
...
See the `ignoreCompatibilityErrorsForPlugins` option in [BootstrapOptions](/reference/typescript-api/common/bootstrap#bootstrapoptions).
