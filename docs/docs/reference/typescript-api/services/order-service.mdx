...
class OrderService implements OnApplicationBootstrap {
    ...
    getRefundDestinations(ctx: RequestContext, orderId: ID) => Promise<Array<{ code: string; description: string }>>;
...
<MemberInfo kind="method" type={`(ctx: <a href='/reference/typescript-api/request/request-context#requestcontext'>RequestContext</a>, orderId: <a href='/reference/typescript-api/common/id#id'>ID</a>) => Promise<Array<{ code: string; description: string }>>`}   />
