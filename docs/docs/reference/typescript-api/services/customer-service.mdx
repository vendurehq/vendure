...
generated: true
---
<GenerationInfo sourceFile="packages/core/src/service/services/customer.service.ts" sourceLine="82" packageName="@vendure/core" />
...
class CustomerService {
    ...
    verifyCustomerEmailAddress(ctx: RequestContext, verificationToken: string, password?: string) => Promise<ErrorResultUnion<VerifyCustomerAccountShopResult, Customer>>;
    verifyCustomerAccount(ctx: RequestContext, customerId: ID, password?: string) => Promise<ErrorResultUnion<VerifyCustomerAccountAdminResult, Customer>>;
...
<MemberInfo kind="method" type={`(ctx: <a href='/reference/typescript-api/request/request-context#requestcontext'>RequestContext</a>, verificationToken: string, password?: string) => Promise<<a href='/reference/typescript-api/errors/error-result-union#errorresultunion'>ErrorResultUnion</a><VerifyCustomerAccountShopResult, <a href='/reference/typescript-api/entities/customer#customer'>Customer</a>>>`}   />
...
<MemberInfo kind="method" type={`(ctx: <a href='/reference/typescript-api/request/request-context#requestcontext'>RequestContext</a>, customerId: <a href='/reference/typescript-api/common/id#id'>ID</a>, password?: string) => Promise<<a href='/reference/typescript-api/errors/error-result-union#errorresultunion'>ErrorResultUnion</a><VerifyCustomerAccountAdminResult, <a href='/reference/typescript-api/entities/customer#customer'>Customer</a>>>`}  since="3.8.0"  />
...
`UserService.verifyUserWithoutToken` for the rules the `password` argument follows.
