...
class UserService {
    ...
    verifyUserWithoutToken(ctx: RequestContext, userId: ID, password?: string) => Promise<User | MissingPasswordError | PasswordAlreadySetError | PasswordValidationError>;
    setPasswordResetToken(ctx: RequestContext, emailAddress: string) => Promise<User | undefined>;
    getUserByPasswordResetToken(ctx: RequestContext, passwordResetToken: string) => Promise<User | undefined>;
...
<MemberInfo kind="method" type={`(ctx: <a href='/reference/typescript-api/request/request-context#requestcontext'>RequestContext</a>, roles: <a href='/reference/typescript-api/entities/role#role'>Role</a>[], identifier: string) => Promise<<a href='/reference/typescript-api/entities/user#user'>User</a>>`}   />
...
### verifyUserWithoutToken

<MemberInfo kind="method" type={`(ctx: <a href='/reference/typescript-api/request/request-context#requestcontext'>RequestContext</a>, userId: <a href='/reference/typescript-api/common/id#id'>ID</a>, password?: string) => Promise<<a href='/reference/typescript-api/entities/user#user'>User</a> | MissingPasswordError | PasswordAlreadySetError | PasswordValidationError>`}  since="3.8.0"  />

Marks a User as `verified`. Unlike `UserService.verifyUserByToken`, no verification
...
[NativeAuthenticationMethod](/reference/typescript-api/entities/authentication-method#nativeauthenticationmethod) with no `passwordHash` requires one, and a credential
...
`UserService.addUnactivatedNativeAuthenticationMethod` leaves behind, and activating it
...
<MemberInfo kind="method" type={`(ctx: <a href='/reference/typescript-api/request/request-context#requestcontext'>RequestContext</a>, passwordResetToken: string) => Promise<<a href='/reference/typescript-api/entities/user#user'>User</a> | undefined>`}  since="3.8.0"  />

Returns the User whose [NativeAuthenticationMethod](/reference/typescript-api/entities/authentication-method#nativeauthenticationmethod) has the given `passwordResetToken` set,
