...
generated: true
---
<GenerationInfo sourceFile="packages/core/src/service/services/collection.service.ts" sourceLine="121" packageName="@vendure/core" />
...
class CollectionService implements OnModuleInit {
    ...
    getBreadcrumbsForMany(ctx: RequestContext, collections: Array<Translated<Collection>>) => Promise<Map<ID, Array<{ name: string; id: ID; slug: string }>>>;
...
### getBreadcrumbsForMany

<MemberInfo kind="method" type={`(ctx: <a href='/reference/typescript-api/request/request-context#requestcontext'>RequestContext</a>, collections: Array<Translated<<a href='/reference/typescript-api/entities/collection#collection'>Collection</a>>>) => Promise<Map<<a href='/reference/typescript-api/common/id#id'>ID</a>, Array<{ name: string; id: <a href='/reference/typescript-api/common/id#id'>ID</a>; slug: string }>>>`}   />
