...
generated: true
---
<GenerationInfo sourceFile="packages/core/src/config/catalog/multi-channel-stock-location-strategy.ts" sourceLine="36" packageName="@vendure/core" since="3.1.0" />
