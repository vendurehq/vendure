...
generated: true
---
<GenerationInfo sourceFile="packages/core/src/entity/channel/channel.entity.ts" sourceLine="40" packageName="@vendure/core" />
...
<MemberInfo kind="property" type={`<a href='/reference/typescript-api/entities/api-key#apikey'>ApiKey</a>[]`}   />
