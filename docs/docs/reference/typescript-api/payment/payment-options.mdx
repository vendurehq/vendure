...
generated: true
---
<GenerationInfo sourceFile="packages/core/src/config/vendure-config.ts" sourceLine="1058" packageName="@vendure/core" />
...
<MemberInfo kind="property" type={`<a href='/reference/typescript-api/payment/refund-destination-strategy#refunddestinationstrategy'>RefundDestinationStrategy</a>[]`} default={`[]`}  since="3.8.0"  />
