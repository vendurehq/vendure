...
generated: true
---
<GenerationInfo sourceFile="packages/core/src/config/vendure-config.ts" sourceLine="1307" packageName="@vendure/core" since="1.6.0" />
...
<MemberInfo kind="property" type={`<a href='/reference/typescript-api/configuration/encryption-strategy#encryptionstrategy'>EncryptionStrategy</a>`} default={`<a href='/reference/typescript-api/configuration/encryption-strategy#defaultencryptionstrategy'>DefaultEncryptionStrategy</a>`}  since="3.8.0"  />

Defines the strategy used to encrypt the values of `secret` custom fields and config args at
rest.
### secretAccessStrategy

<MemberInfo kind="property" type={`<a href='/reference/typescript-api/configuration/secret-access-strategy#secretaccessstrategy'>SecretAccessStrategy</a>`} default={`<a href='/reference/typescript-api/configuration/secret-access-strategy#permissionsecretaccessstrategy'>PermissionSecretAccessStrategy</a>`}  since="3.8.0"  />
