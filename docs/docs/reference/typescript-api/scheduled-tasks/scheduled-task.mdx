...
<MemberInfo kind="method" type={`(config: Partial<Pick<<a href='/reference/typescript-api/scheduled-tasks/scheduled-task#scheduledtaskconfig'>ScheduledTaskConfig</a><C>, 'schedule' | 'timezone' | 'timeout' | 'params'>>) => `}   />
