...
<GenerationInfo sourceFile="packages/core/src/scheduler/scheduled-task.ts" sourceLine="131" packageName="@vendure/core" since="3.3.0" />
...
<MemberInfo kind="method" type={`(update: Partial<Pick<<a href='/reference/typescript-api/scheduled-tasks/scheduled-task#scheduledtaskconfig'>ScheduledTaskConfig</a><C>, 'schedule' | 'timezone' | 'timeout' | 'params'>>) => `}   />
