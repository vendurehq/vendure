...
<GenerationInfo sourceFile="packages/dashboard/src/lib/components/shared/paginated-list-data-table.tsx" sourceLine="438" packageName="@vendure/dashboard" since="3.4.0" />
...
<MemberInfo kind="property" type={`Partial<Record<AllItemFieldKeys<T> | keyof AC, boolean>>`}   />
...
<MemberInfo kind="property" type={`PaginatedListItemFields<T>[]`}   />


### onSelectionChange

<MemberInfo kind="property" type={`(selection: PaginatedListItemFields<T>[]) => void`}   />
...
<MemberInfo kind="property" type={`(params: { error: Error; retry: () => void }) => React.ReactNode`}   />
