...
<GenerationInfo sourceFile="packages/dashboard/src/lib/components/shared/asset/asset-gallery.tsx" sourceLine="200" packageName="@vendure/dashboard" />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/components/shared/asset/asset-gallery.tsx" sourceLine="112" packageName="@vendure/dashboard" />
...
<MemberInfo kind="property" type={`AssetBulkActionsInput`}   />
