...
<GenerationInfo sourceFile="packages/dashboard/src/lib/components/shared/facet-value-selector.tsx" sourceLine="82" packageName="@vendure/dashboard" since="3.4.0" />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/components/shared/facet-value-selector.tsx" sourceLine="28" packageName="@vendure/dashboard" since="3.4.0" />
