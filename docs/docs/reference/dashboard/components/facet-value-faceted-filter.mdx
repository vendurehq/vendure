...
generated: true
---
<GenerationInfo sourceFile="packages/dashboard/src/lib/components/data-table/data-table-facet-value-faceted-filter.tsx" sourceLine="57" packageName="@vendure/dashboard" since="3.6.0" />
