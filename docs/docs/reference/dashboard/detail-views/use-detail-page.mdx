...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/page/use-detail-page.ts" sourceLine="314" packageName="@vendure/dashboard" since="3.3.0" />
...
<MemberInfo kind="property" type={`() => WithLooseCustomFields<Partial<VariablesOf<C>[VarNameCreate]>>`}  since="3.8.0"  />
...
<MemberInfo kind="property" type={`(variables: VariablesOf<C>) => VariablesOf<C>`}  since="3.8.0"  />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/page/use-detail-page.ts" sourceLine="232" packageName="@vendure/dashboard" since="3.3.0" />
