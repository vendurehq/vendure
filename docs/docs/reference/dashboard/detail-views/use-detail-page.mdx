...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/page/use-detail-page.ts" sourceLine="259" packageName="@vendure/dashboard" since="3.3.0" />
...
<MemberInfo kind="property" type={`(schema: ZodObject<any>) => ZodTypeAny`}   />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/page/use-detail-page.ts" sourceLine="177" packageName="@vendure/dashboard" since="3.3.0" />
