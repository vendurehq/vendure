...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/nav-menu/nav-menu-extensions.ts" sourceLine="312" packageName="@vendure/dashboard" since="3.8.0" />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/nav-menu/nav-menu-helpers.ts" sourceLine="37" packageName="@vendure/dashboard" since="3.8.0" />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/nav-menu/nav-menu-helpers.ts" sourceLine="77" packageName="@vendure/dashboard" since="3.8.0" />
