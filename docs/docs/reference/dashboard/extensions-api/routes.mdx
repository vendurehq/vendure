...
generated: true
---
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/extension-api/types/navigation.ts" sourceLine="29" packageName="@vendure/dashboard" since="3.4.0" />
...
<MemberInfo kind="property" type={`DashboardNavMenuItemDefinition`}   />
