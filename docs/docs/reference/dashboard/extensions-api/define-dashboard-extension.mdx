...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/extension-api/define-dashboard-extension.ts" sourceLine="114" packageName="@vendure/dashboard" since="3.3.0" />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/extension-api/extension-api-types.ts" sourceLine="43" packageName="@vendure/dashboard" since="3.3.0" />
...
<MemberInfo kind="property" type={`<a href='/reference/dashboard/extensions-api/refund-destinations#dashboardrefunddestinationdefinition'>DashboardRefundDestinationDefinition</a>[]`}  since="3.8.0"  />
