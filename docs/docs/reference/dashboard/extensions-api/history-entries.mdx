...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/history-entry/history-entry.tsx" sourceLine="76" packageName="@vendure/dashboard" since="3.4.3" />
