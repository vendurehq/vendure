...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/form-engine/form-engine-types.ts" sourceLine="122" packageName="@vendure/dashboard" since="3.4.0" />
...
<MemberInfo kind="property" type={`React.ComponentType<<a href='/reference/dashboard/extensions-api/form-components#dashboardformcomponentsummaryprops'>DashboardFormComponentSummaryProps</a>>`}  since="3.6.0"  />
...
<MemberInfo kind="property" type={`'sm' | 'lg'`}  since="3.6.0"  />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/form-engine/form-engine-types.ts" sourceLine="168" packageName="@vendure/dashboard" since="3.6.0" />

Props received by a [DashboardFormComponentMetadata](/reference/dashboard/extensions-api/form-components#dashboardformcomponentmetadata) `summary` component.
The `value` is the parsed value of the field (arrays for list fields).

```ts title="Signature"
type DashboardFormComponentSummaryProps = {
    value: any;
    fieldDef: ConfigurableFieldDef;
}
```
...
<MemberInfo kind="property" type={`ConfigurableFieldDef`}   />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/form-engine/form-engine-types.ts" sourceLine="201" packageName="@vendure/dashboard" since="3.4.0" />
