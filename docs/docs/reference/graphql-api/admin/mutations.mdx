...
<a name="setroleassignmentsforuser"></a>

## setRoleAssignmentsForUser

<GraphQLDoc
  type="mutation"
  typeName="setRoleAssignmentsForUser"
  typeLinks={{
    User: '/reference/graphql-api/admin/object-types#user',
    ID: '/reference/graphql-api/admin/object-types#id',
    RoleAssignmentInput: '/reference/graphql-api/admin/input-types#roleassignmentinput',
  }}
>
{`"""
