...
<a name="assignrolestouser"></a>

## assignRolesToUser

<GraphQLDoc
  type="mutation"
  typeName="assignRolesToUser"
  typeLinks={{
    User: '/reference/graphql-api/admin/object-types#user',
    AssignRolesToUserInput: '/reference/graphql-api/admin/input-types#assignrolestouserinput',
  }}
>
{`"""
...
<a name="removerolesfromuser"></a>

## removeRolesFromUser

<GraphQLDoc
  type="mutation"
  typeName="removeRolesFromUser"
  typeLinks={{
    User: '/reference/graphql-api/admin/object-types#user',
    RemoveRolesFromUserInput: '/reference/graphql-api/admin/input-types#removerolesfromuserinput',
  }}
>
{`"""
