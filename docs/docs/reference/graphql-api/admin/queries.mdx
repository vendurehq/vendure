...
<GraphQLDoc
  ...
  typeName="apiKeys"
  typeLinks={{
    ApiKeyList: '/reference/graphql-api/admin/object-types#apikeylist',
    ApiKeyListOptions: '/reference/graphql-api/admin/input-types#apikeylistoptions',
  }}
>
{`type Query {
...
<GraphQLDoc
  ...
  typeLinks={{
    ProductOptionGroupList: '/reference/graphql-api/admin/object-types#productoptiongrouplist',
    ProductOptionGroupListOptions: '/reference/graphql-api/admin/input-types#productoptiongrouplistoptions',
  }}
>
{`type Query {
...
<GraphQLDoc
  type="query"
  typeName="roleAssignments"
  typeLinks={{
    RoleAssignmentList: '/reference/graphql-api/admin/object-types#roleassignmentlist',
    RoleAssignmentListOptions: '/reference/graphql-api/admin/input-types#roleassignmentlistoptions',
  }}
>
{`"""
...
<a name="settingsstorefielddefinitions"></a>

## settingsStoreFieldDefinitions

<GraphQLDoc
  type="query"
  typeName="settingsStoreFieldDefinitions"
  typeLinks={{
    SettingsStoreFieldDefinition: '/reference/graphql-api/admin/object-types#settingsstorefielddefinition',
  }}
>
