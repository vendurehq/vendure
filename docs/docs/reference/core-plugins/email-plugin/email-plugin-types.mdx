...
<GenerationInfo sourceFile="packages/email-plugin/src/types.ts" sourceLine="361" packageName="@vendure/email-plugin" />
...
<GenerationInfo sourceFile="packages/email-plugin/src/types.ts" sourceLine="380" packageName="@vendure/email-plugin" />
...
<GenerationInfo sourceFile="packages/email-plugin/src/types.ts" sourceLine="442" packageName="@vendure/email-plugin" />
...
<GenerationInfo sourceFile="packages/email-plugin/src/types.ts" sourceLine="475" packageName="@vendure/email-plugin" />
...
<GenerationInfo sourceFile="packages/email-plugin/src/types.ts" sourceLine="492" packageName="@vendure/email-plugin" since="3.8.0" />

A function used to define the plain-text body of the email.
See [EmailEventHandler](/reference/core-plugins/email-plugin/email-event-handler#emaileventhandler).setPlainTextBody().

The second argument contains the template variables for this email, i.e. the
globalTemplateVars merged with the output of the [SetTemplateVarsFn](/reference/core-plugins/email-plugin/email-plugin-types#settemplatevarsfn).

```ts title="Signature"
type SetPlainTextBodyFn<Event> = (
    event: Event,
...
<GenerationInfo sourceFile="packages/email-plugin/src/types.ts" sourceLine="506" packageName="@vendure/email-plugin" />
...
<GenerationInfo sourceFile="packages/email-plugin/src/types.ts" sourceLine="514" packageName="@vendure/email-plugin" />
...
<GenerationInfo sourceFile="packages/email-plugin/src/types.ts" sourceLine="528" packageName="@vendure/email-plugin" since="1.1.0" />
...
<GenerationInfo sourceFile="packages/email-plugin/src/types.ts" sourceLine="554" packageName="@vendure/email-plugin" since="1.1.0" />
...
<GenerationInfo sourceFile="packages/email-plugin/src/types.ts" sourceLine="566" packageName="@vendure/email-plugin" since="3.1.0" />
...
<GenerationInfo sourceFile="packages/email-plugin/src/types.ts" sourceLine="576" packageName="@vendure/email-plugin" since="3.1.0" />
