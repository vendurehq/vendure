...
generated: true
---
<GenerationInfo sourceFile="packages/email-plugin/src/handler/event-handler.ts" sourceLine="151" packageName="@vendure/email-plugin" />
...
<MemberInfo kind="method" type={`(setPlainTextBodyFn: <a href='/reference/core-plugins/email-plugin/email-plugin-types#setplaintextbodyfn'>SetPlainTextBodyFn</a><Event>) => <a href='/reference/core-plugins/email-plugin/email-event-handler#emaileventhandler'>EmailEventHandler</a><T, Event>`}  since="3.8.0"  />
