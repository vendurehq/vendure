...
generated: true
---
<GenerationInfo sourceFile="packages/mcp-sdk/src/mcp-tool.decorator.ts" sourceLine="47" packageName="@vendure/mcp-sdk" since="3.8.0" />

Describes a single MCP tool. Attach this to a class with the [McpTool](/reference/core-plugins/mcp-plugin/mcp-tool#mcptool) decorator; the MCP
