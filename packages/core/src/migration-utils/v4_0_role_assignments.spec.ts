...
describe('migrateRoleAssignmentData()', () => {
    ...
    async function createSchema(options: { idType: 'increment' | 'uuid' } = { idType: 'increment' }) {
        await queryRunner.query(
            `CREATE TABLE "role" ("id" integer PRIMARY KEY AUTOINCREMENT, "code" varchar NOT NULL)`,
        );
        await queryRunner.query(
    ...
    async function seedData() {
        await queryRunner.query(
            `INSERT INTO "role" ("id", "code") VALUES
             (1, '__super_admin_role__'), (2, '__customer_role__'), (3, 'sales')`,
        );
        ...
        // user 4: customer who also holds the sales role
        await queryRunner.query(
