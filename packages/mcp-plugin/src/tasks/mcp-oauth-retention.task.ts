 ...
 * session created for each expired grant, authorization requests and codes that are expired or
 * spent, grants that have been dead longer than the `logging.ttlDays` window, and clients that
